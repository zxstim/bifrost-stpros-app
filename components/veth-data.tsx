  ...
  return (
    <div className="grid grid-cols-3 border-t-2 border-muted-foreground/20 pt-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-sm md:text-lg text-muted-foreground">Total Value Locked</h1>
        {isLoading ? (
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-sm md:text-lg text-muted-foreground">Total stakers</h1>
        {isLoading ? (
          <Skeleton className="w-full h-4" />
        ) : isError ? (
          <p className="font-bold text-4xl">--</p>
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-sm md:text-lg text-muted-foreground">Current APY</h1>
        {isLoading ? (
          <Skeleton className="w-full h-4" />
        ) : isError ? (
          <p className="font-bold text-4xl">--%</p>
